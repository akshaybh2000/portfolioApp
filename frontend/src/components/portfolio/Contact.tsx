...
export function Contact() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const data = await postData("/inquiries", {
        name: form.name,
        email: form.email,
        phone: form.phone,
        budget: form.budget,
        projectRequirement: form.message,
      });
      ...
      <div className="mt-16 grid gap-8 lg:grid-cols-5">
        ...
        >
          <InfoLine
            Icon={Mail}
            title="Email"
            value="info.pranaksh@gmail.com"
            href="mailto:info.pranaksh@gmail.com"
          />
          <InfoLine
            Icon={MessageCircle}
            title="WhatsApp"
            value="+91 77098 89712"
            href="https://wa.me/917709889712"
          />
          <InfoLine
            Icon={User}
            title="Instagram"
