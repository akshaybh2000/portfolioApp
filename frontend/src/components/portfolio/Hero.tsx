            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
                ...
                >
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-base text-muted-foreground sm:text-lg">
                        Professional Website Development, Mobile App Development, UI/UX Design, and
                    ...
                    <div className="mx-auto mt-16 grid max-w-3xl grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={s.l} className="glass rounded-2xl p-4 text-center">
                                <div className="text-2xl font-bold text-gradient sm:text-3xl">{s.n}</div>
                ...
                <div className="pointer-events-none absolute inset-0 hidden lg:block">
                    <FloatingIcon Icon={Code2} className="left-[8%] top-[20%]" delay={0} />
                    <FloatingIcon Icon={Rocket} className="right-[10%] top-[28%]" delay={1} />
                    <FloatingIcon Icon={Layers} className="left-[12%] bottom-[15%]" delay={2} />
                </div>
            </div>
        </section>
    );
